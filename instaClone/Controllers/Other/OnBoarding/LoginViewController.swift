...
class LoginViewController: UIViewController {
    ...
    private let usernameEmailField: UITextField = {
        ...
        //define a tecla enter como next
        field.returnKeyType = .next
        
        field.leftViewMode = .always
        field.leftView = UIView(frame: CGRect(x: 0, y: 0, width: 10, height: 0))
        
        //indentifica quando a tecla shift está precionada
        field.autocapitalizationType = .none
        
        //desabilita o corretor automatico
    ...
    override func viewDidLayoutSubviews() {
        ...
        creatAccountButton.frame = CGRect(x: 25, y: loginButton.bottom + 10, width: view.width - 50, height: 52)
    ...
    private func configureHeaderView(){
        ...
        //add insta logo
        let imageView = UIImageView(image: UIImage(named: "instaTextLogo"))
        ...
        AuthManager.shared.loginUser(username: username, email: email, password: password){ success in
            DispatchQueue.main.async {
                if success{
                    ...
                    //error occurred
                    let alert = UIAlertController(title: "Log In Error", message: "we are unable to log in", preferredStyle: .alert)
